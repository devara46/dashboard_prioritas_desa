...
function permutation(rand, rank) {
...
describe("selections agree with coordinate arithmetic", () => {
    it("reads what the full read holds at those coordinates", async () => {
        ...
        for (let n = 0; n < CASES; n++) {
            ...
            const actual = await zarr.get(arr, toSelection(sel));
            const got = surviving(sel, shape).lengths.length === 0
                ? [actual]
                : toLogical(actual);
...
//# sourceMappingURL=selection-property.test.js.map