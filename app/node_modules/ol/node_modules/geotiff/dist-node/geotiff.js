...
async function fromUrl(url, options = {}, signal) {
    ...
    return GeoTIFF.fromSource((0, remote_js_1.makeRemoteSource)(url, remoteOptions), undefined, signal);
}
/**
...
async function fromCustomClient(client, options = {}, signal) {
    ...
    return GeoTIFF.fromSource((0, remote_js_1.makeCustomSource)(client, customOptions), undefined, signal);
}
/**
...
async function fromUrls(mainUrl, overviewUrls = [], options = {}, signal) {
    const remoteOptions = { blockSize: 65536, ...options };
    const mainFile = await GeoTIFF.fromSource((0, remote_js_1.makeRemoteSource)(mainUrl, remoteOptions), undefined, signal);
    const overviewFiles = await Promise.all(overviewUrls.map((url) => GeoTIFF.fromSource((0, remote_js_1.makeRemoteSource)(url, remoteOptions), undefined, signal)));
