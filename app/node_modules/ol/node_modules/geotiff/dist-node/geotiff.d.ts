 ...
 */
export function fromUrl(url: string, options?: SourceOptions, signal?: AbortSignal): Promise<GeoTIFF>;
/**
 ...
 * @returns {Promise<GeoTIFF>} The resulting GeoTIFF file.
 */
export function fromCustomClient(client: BaseClient, options?: SourceOptions, signal?: AbortSignal): Promise<GeoTIFF>;
/**
 ...
 */
export function fromUrls(mainUrl: string, overviewUrls?: string[], options?: SourceOptions, signal?: AbortSignal): Promise<MultiGeoTIFF>;
/**
